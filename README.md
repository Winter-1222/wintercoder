...
第 0 至第 9 章已经完成。第 7 章包含统一消息序列、大结果落盘、旧工具结果清理、手动/自动压缩、超长请求单次重试和连续失败暂停。第 8 章加入会话保存/恢复/切换、项目指令和项目记忆。

第 9 章加入统一 Agent 工具、定义式与 Fork 子任务、前后台管理、独立权限、重启续接和桌面子任务卡片。
...
- [第 9 章：子 Agent](docs/chapters/09-subagents/README.md)
